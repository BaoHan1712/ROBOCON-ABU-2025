		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 4:
										...
										break;
									case 5:
										HMI_DMI("EN XOAY:",ENCODER_XOAY(),5);	
										break;
									case 6:
										HMI_DMI("JoyStick:",JTA,6);
										break;
									case 7:														
										HMI_DMI("Luc_Ban:",force,7);
										break;
									case 8:
...
//										}
										break;
									case 10:
										HMI_DMI("BATERY:",GP_BTN[8],8);
										break;
									case 11:
										HMI_DMI("result :" ,result,11);  					
										break;
									case 12:
										HMI_DMI("final_result:",final_result,12);  						
										break;
									case 13:
                              ...
                              snprintf(_ghep_bit, sizeof(_ghep_bit), "%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d",
                                    ...
                                    GPIO_ReadOutputDataBit(GPIOB, GPIO_Pin_7)
										...
										break;
									case 18:
										HMI_DMI("Luc_ban_lidar:",calculated_force,16);
										break;
