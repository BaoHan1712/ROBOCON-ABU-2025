...
#define mor_2h_next 											 		DATA_SPEED[6]=1
#define mor_2h_back 													DATA_SPEED[6]=0
#define	mor_2h																DATA_SPEED[7]

#define	DIA_CHI_START3 												DATA_SPEED[8]=255
#define	ID3 		 															DATA_SPEED[9]=3
#define mor_4h_next 													DATA_SPEED[10]=1
#define mor_4h_back 													DATA_SPEED[10]=0
#define	mor_4h 																DATA_SPEED[11]

#define	DIA_CHI_START4 												DATA_SPEED[12]=255
#define	ID4 		 															DATA_SPEED[13]=4
#define mor_6h_next					 									DATA_SPEED[14]=1
#define mor_6h_back														DATA_SPEED[14]=0
#define	mor_6h 		 														DATA_SPEED[15]

#define	DIA_CHI_START5												DATA_SPEED[16]=255
#define	ID5	 																	DATA_SPEED[17]=5
#define mor_8h_next							 							DATA_SPEED[18]=0
#define mor_8h_back														DATA_SPEED[18]=1   
#define	mor_8h 		 														DATA_SPEED[19]

#define	DIA_CHI_START6 												DATA_SPEED[20]=255
#define	ID6	 		 															DATA_SPEED[21]=6
#define mor_10h_next													DATA_SPEED[22]=1
#define mor_10h_back													DATA_SPEED[22]=0
#define	mor_10h		 														DATA_SPEED[23]

#define	DIA_CHI_START7											  DATA_SPEED[24]=255
#define	ID7																    DATA_SPEED[25]=7
#define Mor_CamRotate_next					 					DATA_SPEED[26]=1
#define Mor_CamRotate_back										DATA_SPEED[26]=0
#define	Mor_CamRotate		 											DATA_SPEED[27]

#define	DIA_CHI_START8											  DATA_SPEED[28]=255 // -- OK
#define	ID8																    DATA_SPEED[29]=8
#define Mor_Nang				 							        DATA_SPEED[30]=1
#define Mor_Ha										            DATA_SPEED[30]=0
#define	Mor_NangHa														DATA_SPEED[31]

#define	DIA_CHI_START9											  DATA_SPEED[32]=255 // -- OK
...
#define Cylinder_next				 									DATA_SPEED[46]=0
#define Cylinder_back													DATA_SPEED[46]=1
#define	Cylinder															DATA_SPEED[47]
...
#define   XI_LANH_KEPBONG_MO								GPIO_WriteBit(GPIOB,GPIO_Pin_6,1) // -- OK
#define   XI_LANH_KEPBONG_DONG							GPIO_WriteBit(GPIOB,GPIO_Pin_6,0)

#define   XI_LANH_DAY_BONG_RA								GPIO_WriteBit(GPIOB,GPIO_Pin_11,1) // --ok
#define   XI_LANH_DAY_BONG_VAO							GPIO_WriteBit(GPIOB,GPIO_Pin_11,0)

#define   XI_LANH_LAY_BONG_LEN							GPIO_WriteBit(GPIOB,GPIO_Pin_14,1) // -- OK
#define   XI_LANH_LAY_BONG_XUONG						GPIO_WriteBit(GPIOB,GPIO_Pin_14,0)

#define   XI_LANH_TONG_ON										GPIO_WriteBit(GPIOB,GPIO_Pin_15,1) // -- OK
#define   XI_LANH_TONG_OFF									GPIO_WriteBit(GPIOB,GPIO_Pin_15,0)
...
#define  XI_LANH_RE_RA											GPIO_WriteBit(GPIOB,GPIO_Pin_7,1) // -- OK
#define  XI_LANH_RE_VAO											GPIO_WriteBit(GPIOB,GPIO_Pin_7,0)

#define  XI_LANH_NANGHAKEP_XUONG						GPIO_WriteBit(GPIOB,GPIO_Pin_0,1) // -- OK
#define  XI_LANH_NANGHAKEP_LEN							GPIO_WriteBit(GPIOB,GPIO_Pin_0,0)


#define  XI_LANH_DAYBONG_XUONG							GPIO_WriteBit(GPIOB,GPIO_Pin_10,1) // -- OK
#define  XI_LANH_DAYBONG_LEN								GPIO_WriteBit(GPIOB,GPIO_Pin_10,0)
...
#define  CB_NHAN_LUA1														GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_7)
#define  CB_CHAM_THANH_LUA											GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_0)

#define  CB_TAY_GAP_BONG_DUOI										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_5)
...
#define  CB_GIU_BONG 														GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2)
#define  CB_RE_BONG															GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_12)

// ==================================CAM BIEN ROBOT CHAY 3 DIEM(14H30,04/12/2024)=================================================//
#define  CB_NHAN_BONG_BO_BAN										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_10)
#define  CB_HOME_BAN_XOAY												GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_4)
#define  CB_XI_LANH_TRUOT_DAY_VAO								GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_1)
#define  CB_XI_LANH_TRUOT_DAY_RA				  			GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_14)
#define  CB_NHAN_BONG	 													GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_0) // -- OK
//NUT BAM
#define		CHON_SAN												 			GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_1)

#define LED_TAM_CHUAN           								GPIO_WriteBit(GPIOB,GPIO_Pin_0,1)
#define LED_TAM_LECH           									GPIO_WriteBit(GPIOB,GPIO_Pin_0,0)
...
//=============================ENCODER======================================
#define Encoder_Xoay_Mam	(vs32)((num_over_t1<<16) | TIM_GetCounter(TIM1))/10
...
int		BienTroNongBanValue, bientronangluaValue,bientronangbongValue;
vu16 _ADC1_Value[8];
...
extern int final_result_lidar;
extern unsigned char GP_BTN [15];
extern int calculated_force;
extern int calculated_distance;

extern float lucBanlidar = 0;
...
char Do_Xanh;
//////////////////////////chong nhieu encoder////////////////////
vs32 Encoder_XoayMam()
{
	vs32 en, enOld = Encoder_Xoay_Mam;
	int i=0;
	while( i < 2)
	{
		en = Encoder_Xoay_Mam;
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 1:
										...
										break;
									case 2:
										HMI_DMI("GOC BAN:",BienTroNongBanValue,2);
										break;
									case 3:
										HMI_DMI("VI TRI BAN:",taget_BT_Xoay,3);
										break;
									case 4:
										HMI_DMI("goc_lidar:",calculated_distance,4);   
										break;
									case 5:
										HMI_DMI("offset:",received_offset,5);	
										break;
									case 6:
										HMI_DMI("distance:",received_distance,6);
										break;
									case 7:														
										HMI_DMI("Luc_Ban_lidar:",calculated_force,7);
										break;
									case 8:
										HMI_DMI("Goc_Ban_auto:", degree_F,10); //ADC 1;
										break;
									case 9:
										HMI_DMI("GT_LAZER_TRAI:",lazeTraiValue,9);
										break;
//										if(NUT_CHUYEN_SAN == 1){
...
//										}
										break;
									case 10:
										//HMI_DMI("Luc_Ban:",force,8);
										break;
									case 11:
										//HMI_DMI("offset :" ,received_offset,11);  					
										break;
									case 12:
										HMI_DMI("Luc_Ban_lazer:",force,12);  						
										break;
									case 13:
										HMI_DMI("JoyStick:",JTA,13);									
										break;
									case 14:
										HMI_DMI("final_result_lazer:",final_result,14);  
										break;		
									case 15: 
										HMI_DMI("final_result_lidar:",final_result_lidar,15); 
										break;	
								  case 16:
