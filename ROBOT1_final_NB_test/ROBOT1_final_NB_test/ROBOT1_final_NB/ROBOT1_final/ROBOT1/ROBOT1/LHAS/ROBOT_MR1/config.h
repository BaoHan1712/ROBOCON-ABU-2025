...
#define Mor_0h_next 													DATA_SPEED[6]=1
#define Mor_0h_back 													DATA_SPEED[6]=0
#define	Mor_0h																DATA_SPEED[7]


#define	DIA_CHI_STAR3 												DATA_SPEED[8]=255
#define	ID3	 		 															DATA_SPEED[9]=3
#define mor_rotate_8h_next										DATA_SPEED[10]=0
#define mor_rotate_8h_back										DATA_SPEED[10]=1
...
#define mor_rotate_4h_next 										DATA_SPEED[18]=1
#define mor_rotate_4h_back										DATA_SPEED[18]=0
...
#define nang_next					 				DATA_SPEED[34]=0
#define nang_back									DATA_SPEED[34]=1
#define	nang_ha									  DATA_SPEED[35]

#define	DIA_CHI_START10						DATA_SPEED[36]=255 // -- OK
#define	ID10									 		DATA_SPEED[37]=10
#define Ban_1_next						    DATA_SPEED[38]=0
#define Ban_1_back				        DATA_SPEED[38]=1
#define	Ban_1											DATA_SPEED[39]

#define	DIA_CHI_START11						DATA_SPEED[40]=255 // -- OK
#define	ID11											DATA_SPEED[41]=11 
#define Ban_2_next				 				DATA_SPEED[42]=1
#define Ban_2_back								DATA_SPEED[42]=0
#define	Ban_2											DATA_SPEED[43]

#define	DIA_CHI_START12						DATA_SPEED[44]=255 // -- OK
#define	ID12											DATA_SPEED[45]=12 
#define Ban_3_next				 				DATA_SPEED[46]=0
#define Ban_3_back								DATA_SPEED[46]=1
#define	Ban_3											DATA_SPEED[47]	


#define	DIA_CHI_START13						DATA_SPEED[48]=255 // -- OK
#define	ID13											DATA_SPEED[49]=13 
#define CamRotate_next						DATA_SPEED[50]=1
#define CamRotate_back						DATA_SPEED[50]=0
#define	CamRotate									DATA_SPEED[51]

#define	DIA_CHI_START14						DATA_SPEED[52]=255 // -- OK
#define	ID14											DATA_SPEED[53]=14 
#define Cylinder_ban_ON						DATA_SPEED[54]=1
#define Cylinder_ban_OFF					DATA_SPEED[54]=0
#define	Cylinder_ban							DATA_SPEED[55]


#define	DIA_CHI_START15						DATA_SPEED[56]=255 // -- OK
#define	ID15											DATA_SPEED[57]=15 
#define Mor_Shoot_next						DATA_SPEED[58]=0
#define Mor_Shoot_back						DATA_SPEED[58]=1
#define	Mor_Shoot									DATA_SPEED[59]

#define	DIA_CHI_START16						DATA_SPEED[60]=255 // -- OK
#define	ID16											DATA_SPEED[61]=16 
#define LAZER_ON									DATA_SPEED[62]=1
#define LAZER_OFF									DATA_SPEED[62]=0
#define	LAZER											DATA_SPEED[63]
...
#define bien_tro_nang_bong									_ADC1_Value[0]
#define bien_tro_nang_lua										_ADC1_Value[1]
#define bien_tro_xoay_nong									_ADC1_Value[3]

//xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx OUTPUT xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx//
//CO CAU LAY BONG

#define   XI_LANH_DAY_BONG_RA								GPIO_WriteBit(GPIOB,GPIO_Pin_0,1) // -- OK
#define   XI_LANH_DAY_BONG_VAO							GPIO_WriteBit(GPIOB,GPIO_Pin_0,0)

#define   XI_LANH_NANG_NONG									GPIO_WriteBit(GPIOC,GPIO_Pin_9,1) // -- OK
#define   XI_LANH_HA_NONG										GPIO_WriteBit(GPIOC,GPIO_Pin_9,0)
...
#define  CB_NHAN_BONG_BO_BAN										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_1)// -- OK
...
#define  Home_0h																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2) // -- OK
#define  Home_4h																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_15)
#define  Home_8h																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_14)
//#define  Home_Front_Right										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_14)
//================================INPUT==================================//


#define  CB_TRAI																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_12)
#define  CB_GIUA_TRAI														GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_10)
#define  CB_GIUA_PHAI														GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_13)
#define  CB_PHAI																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_4)
...
//=============================ENCODER======================================
//#define Encoder_Xoay		(vs32)((num_over_t4<<16) | TIM_GetCounter(TIM4))/50
//#define Encoder_0h			(vs32)((num_over_t3<<16) | TIM_GetCounter(TIM3))/8.95 
//#define Encoder_4h			(vs32)((num_over_t5<<16) | TIM_GetCounter(TIM5))/8.95 //TRONG78.32306  // 61.3
//#define Encoder_8h			(vs32)((num_over_t2<<16) | TIM_GetCounter(TIM2))/7.1

#define Encoder_Xoay		(vs32)((num_over_t4<<16) | TIM_GetCounter(TIM4))/50
#define Encoder_0h			(vs32)((num_over_t3<<16) | TIM_GetCounter(TIM3))/61.3 
#define Encoder_4h			(vs32)((num_over_t5<<16) | TIM_GetCounter(TIM5))/61.3 //TRONG78.32306  // 61.3
#define Encoder_8h			(vs32)((num_over_t2<<16) | TIM_GetCounter(TIM2))/61.3
...
int		BienTroNongBanValue, bientronangluaValue,bientronangbongValue,BienTroBanValue;
vu16 _ADC1_Value[8];
...
extern int final_F_chuyen;
extern int force_chuyen;
...
int goc_ban = 440;
//== Mam Xoay
int target_BT_Xoay = 645;
int Min_BT_Xoay =  50;
int Max_BT_Xoay = 1000;

//== Nang Ha
int target_Nang_Ha;
int Min_Nang_Ha = 370;     //49;
int Max_Nang_Ha = 910	- 5; // 950	

//== Kich ban
int Target_BT_Shoot = 400;
int Max_BT_Shoot = 475;
int Min_BT_Shoot = 215;
...
vu16 received_BC = 0;  
vu16 received_CT = 0;
// H?m x? l? d? li?u gi? nguy?n c?u tr?c
void ProcessReceivedData_2(void)
{
    ...
    if (RX_UART4[0] == 0x02)
    {
        distance_1 = (RX_UART4[1] << 8) | RX_UART4[2];
				distance_2 = (RX_UART4[3] << 8) | RX_UART4[4];


        received_BC = distance_1;
				received_CT = distance_2;
    }
    else
    {
        received_CT = 4;
...
int canh_trai = 15;
int canh_phai = 22;
int tong_bien_tro_bang;
int bien_tro_canh_phai;

int custom_xoay = 0;
int custom_speed_xoay = 0;

int bt_xoay_chia_value = 0;
int distanceRobotToBackboard = 0;
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 2:
										...
										break;
									case 3:
										HMI_DMI(" value_ctrai :",value_ctrai,3);
									//	HMI_DMI("vu_gocXoay :",demVui,3);
										break;
									case 4:
										HMI_DMI("Luc Ban: ",final_force,4);
										//HMI_DMI("vu_v: ",_robotAngle,4);
										break;
									case 5:
										HMI_DMI("LAZER_BAN ",lazeTruocValue,5);
										//HMI_DMI("vu_omega: ",demVui,5);
										break;
									case 6:
									//	HMI_DMI("LAZER_BAN_2 ",lazeSauValue,6);
									...
									case 7:
										...
										break;
									case 8:
									//	HMI_DMI("BAT tay game ",BAT,8);
									HMI_DMI("ENCODER_8H ",ENCODER_8h(),8);
										break;
									case 9:
										HMI_DMI("ENCODER_XOAY ",ENCODER_XOAY(),9);
										break;
										if(CHON_SAN == 1){
											HMI_DMI("NUT CHUYEN SAN: DO",CHON_SAN,9);
										}
										else{
											HMI_DMI("NUT CHUYEN SAN: XANH",CHON_SAN,9);
										}
										break;
									case 10:	  
									HMI_DMI("BT_NANG_NONG:",bientronangluaValue,10);
										break;
									case 11:
										HMI_DMI("BT_Shoot :",BienTroBanValue,11);  					
										break;
									case 12:
										HMI_DMI("force_L:",force_F,12);  						
										break;
									case 13:
										HMI_DMI("value_cphai",value_cphai,13);   
										break;
									case 14:
										//HMI_DMI("LAZER_PHAI:",lazePhaiValue,14);  
									HMI_DMI("cong_tru_luc:",cong_tru_luc,14 ); 
										break;		
									case 15:
										HMI_DMI("min_laze_Ban:",min_laze_Ban,15); 
										break;
								  case 16:
                              ...
                              snprintf(_ghep_bit, sizeof(_ghep_bit), "%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d",
                                    ...
                                    GPIO_ReadOutputDataBit(GPIOB, GPIO_Pin_7)
										...
										HMI_PUTS("OUT:",_ghep_bit,18);
										break;	
									case 18:
										HMI_DMI("",min_laze_Ban,42);   
										break;
									case 19:
										//HMI_DMI("LAZER_PHAI:",lazePhaiValue,14);  
									HMI_DMI("",cong_tru_luc,43); 
										break;		
									case 20:
