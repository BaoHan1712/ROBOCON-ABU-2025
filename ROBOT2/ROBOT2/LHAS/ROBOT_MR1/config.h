...
#define Ban_1_next						    DATA_SPEED[38]=1
#define Ban_1_back				        DATA_SPEED[38]=0
#define	Ban_1											DATA_SPEED[39]

#define	DIA_CHI_START11						DATA_SPEED[40]=255 // -- OK
#define	ID11											DATA_SPEED[41]=11 
#define Ban_2_next				 				DATA_SPEED[42]=0
#define Ban_2_back								DATA_SPEED[42]=1 
...
#define LAZER_ON									DATA_SPEED[50]=1
#define LAZER_OFF									DATA_SPEED[50]=0
#define	LAZER											DATA_SPEED[51]
...
#define Nongban_next							DATA_SPEED[58]=0
#define Nongban_back							DATA_SPEED[58]=1
#define	Nongban										DATA_SPEED[59]

// 
#define	byteStart20														DATA_SPEED[76]=0xff	
#define	ID20	 															  DATA_SPEED[77]=20		// Van set ID 20
//#define DriverVan_On    											motorData[78]=1
//#define DriverVan_Off 						    			  motorData[78]=0
#define	DriverVan    									  			DATA_SPEED[79]
...
#define XI_LANH_DAY_BONG_RA   DriverVan |= 0x01
#define XI_LANH_DAY_BONG_VAO  DriverVan &= 0xFE

#define XI_LANH_NANG_NONG   DriverVan |= 0x02
#define XI_LANH_HA_NONG  		DriverVan &= 0xFD

#define Van_3_on   DriverVan |= 0x04
#define Van_3_off  DriverVan &= 0xFB

#define Van_4_on   DriverVan |= 0x08
#define Van_4_off  DriverVan &= 0xF7

#define Van_5_on   DriverVan |= 0x10
#define Van_5_off  DriverVan &= 0xEF

#define Van_6_on   DriverVan |= 0x20
#define Van_6_off  DriverVan &= 0xDF

#define Van_7_on   DriverVan |= 0x40
#define Van_7_off  DriverVan &= 0xBF

#define Van_8_on   DriverVan |= 0x80
#define Van_8_off  DriverVan &= 0x7F
...
//#define   XI_LANH_DAY_BONG_RA								GPIO_WriteBit(GPIOC,GPIO_Pin_8,1) // -- OK
//#define   XI_LANH_DAY_BONG_VAO							GPIO_WriteBit(GPIOC,GPIO_Pin_8,0)
...
#define  CB_TRAI																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_3)
#define  CB_GIUA																GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_13)
...
#define Encoder_4h			(vs32)((num_over_t5<<16) | TIM_GetCounter(TIM5))/61.3 //TRONG78.32306
#define Encoder_8h			(vs32)((num_over_t2<<16) | TIM_GetCounter(TIM2))/61.3
//#define Encoder_Front_Left	(vs32)((num_over_t5<<16) | TIM_GetCounter(TIM5))/8.6  
//#define Encoder_Front_Right	(vs32)((num_over_t2<<16) | TIM_GetCounter(TIM2))/8.6
//#define Encoder_Rear_Left		(vs32)((num_over_t4<<16) | TIM_GetCounter(TIM4))/8.6
//#define Encoder_Rear_Right	(vs32)((num_over_t3<<16) | TIM_GetCounter(TIM3))/8.6
...
int target_Nang_Ha;
int Min_Nang_Ha = 85;     //49;
int Max_Nang_Ha = 947	- 10; // 937	
...
void ProcessReceivedData_2(void)
{
    ...
    if (RX_UART4[0] == 0x11 && RX_UART4[3] == 0x12)
    {
        distance_2 = RX_UART4[1]  | (RX_UART4[2] << 8);
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 2:
										...
										break;
									case 3:
										HMI_DMI(" LUC_chuyen :",final_F_chuyen,3);
									...
									case 8:
										...
										break;
									case 9:
										HMI_DMI("ENCODER_RR ",ENCODER_XOAY(),9);
										break;
										if(CHON_SAN == 1){
									...
									HMI_DMI("DC:",DC,10);
										break;
									case 11:
										HMI_DMI("CHUYEN_LAZER :",Luc_CHUYENLASER,11);  					
										break;
									case 12:
										HMI_DMI("force_L:",force_F,12);  						
										break;
									case 13:
										HMI_DMI("distance :",rx_chuyen,13);   
										break;
									case 14:
										HMI_DMI("LAZER_PHAI:",lazePhaiValue,14);  
										break;		
									case 15:
										HMI_DMI("LAZER_TRAI:",lazeTraiValue,15); 
										break;
								  case 16:
