		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 12:
										...
										break;
									case 13:
										HMI_DMI("value_cphai",canh_phai,13);   
										break;
									case 14:
										//HMI_DMI("LAZER_PHAI:",lazePhaiValue,14);  
									HMI_DMI("tru hao luc:",truhaolucban,14 ); 
										break;		
									case 15:
                              ...
                              snprintf(_ghep_bit, sizeof(_ghep_bit), "%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d",
                                    ...
                                    GPIO_ReadOutputDataBit(GPIOB, GPIO_Pin_7)
										...
										break;	
									case 18:
										HMI_DMI("",final_force,42);   
										break;
									case 19:
										//HMI_DMI("LAZER_PHAI:",lazePhaiValue,14);  
									HMI_DMI("",distanceRobotToBackboard,43); 
										break;		
									case 20:
										HMI_DMI("",TamRo,44); 
										break;
