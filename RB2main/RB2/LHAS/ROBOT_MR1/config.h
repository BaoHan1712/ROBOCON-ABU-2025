...
#define Ban_3_next				 				DATA_SPEED[46]=1
#define Ban_3_back								DATA_SPEED[46]=0
...
int target_Nang_Ha;
int Min_Nang_Ha = 41;     //49;
int Max_Nang_Ha = 920	- 10;
...
/////////////////////////////////////////////	   
   ...
   DMA_InitStructure.DMA_BufferSize = 16;//(uint16_t)sizeof(Buffer);
...
{		
    ...
    // Cấu hình clock cho các ngoại vi
    ...
    // Cấu hình DMA - chỉnh sửa để giống UART6
    ...
    DMA_InitStructure.DMA_PeripheralDataSize = DMA_PeripheralDataSize_Byte;
    DMA_InitStructure.DMA_MemoryDataSize = DMA_MemoryDataSize_Byte;
    DMA_InitStructure.DMA_Mode = DMA_Mode_Normal; // Thay đổi từ Circular sang Normal
    DMA_InitStructure.DMA_Priority = DMA_Priority_High;
...
// Hàm xử lý dữ liệu giữ nguyên cấu trúc
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 4:
										...
										break;
									case 5:
										HMI_DMI("Gia_tri_lazer ",lazeTruocValue,5);
									...
									HMI_DMI("BT_NANG_NONG:",bientronangluaValue,10);
										break;
									case 11:
										HMI_DMI("offset_2 :",received_offset_2,11);  					
										break;
									case 12:
										HMI_DMI("dis2:",received_distance_2,12);  						
										break;
									case 13:
									...
									case 14:
										...
										break;		
									case 15:
										HMI_DMI("Force_track:",final_F_chuyen,15); 
										break;
								  case 16:
