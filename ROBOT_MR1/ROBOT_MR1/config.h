...
#define mor_rotate_rear_left_next 					 	DATA_SPEED[2]=1
#define mor_rotate_rear_left_back							DATA_SPEED[2]=0
...
#define mor_rotate_rear_right_next 						DATA_SPEED[10]=1
#define mor_rotate_rear_right_back						DATA_SPEED[10]=0
#define	mor_rotate_rear_right 								DATA_SPEED[11]

#define	DIA_CHI_START4												DATA_SPEED[12]=255
#define	ID4	 																	DATA_SPEED[13]=4
#define Mor_RearRight_next							 			DATA_SPEED[14]=0
#define Mor_RearRight_back										DATA_SPEED[14]=1   
...
#define Mor_FrontRight_next					 					DATA_SPEED[22]=0
#define Mor_FrontRight_back										DATA_SPEED[22]=1
...
#define   XI_LANH_DAY_BONG_RA								GPIO_WriteBit(GPIOB,GPIO_Pin_10,1) // -- OK
#define   XI_LANH_DAY_BONG_VAO							GPIO_WriteBit(GPIOB,GPIO_Pin_10,0)

#define   XI_LANH_NANG_NONG									GPIO_WriteBit(GPIOB,GPIO_Pin_13,1) // -- OK
#define   XI_LANH_HA_NONG										GPIO_WriteBit(GPIOB,GPIO_Pin_13,0)
...
#define  Home_Rear_Left											GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_2) // -- OK
#define  Home_Rear_Right										GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_15)
...
#define LED_TAM_CHUAN           								GPIO_WriteBit(GPIOD,GPIO_Pin_13,1)
#define LED_TAM_LECH           									GPIO_WriteBit(GPIOD,GPIO_Pin_13,0)
...
#define Encoder_Front_Left	(vs32)((num_over_t5<<16) | TIM_GetCounter(TIM5))/8.75  
#define Encoder_Front_Right	(vs32)((num_over_t2<<16) | TIM_GetCounter(TIM2))/8.75
#define Encoder_Rear_Left		(vs32)((num_over_t4<<16) | TIM_GetCounter(TIM4))/8.75
#define Encoder_Rear_Right	(vs32)((num_over_t3<<16) | TIM_GetCounter(TIM3))/8.75
		...
		char*camera="11111111111111111111110111111111";
							...
							switch (_so_dong) {
									...
									case 2:
										...
										break;
									case 3:
										HMI_DMI("BT_MAM_XOAY :",BienTroXoayValue,3);
										break;
									case 4:
										HMI_DMI("Luc Ban: ",degree,4);
										break;
									case 5:
