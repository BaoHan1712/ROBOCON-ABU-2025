...
void robotGamePadControl(void)
{
   ...
   //calculate_angle();
	...
	if (!UP && !DOWN && !RIGHT && !LEFT && rJoy_LR && !R2)
	{				  // Khong dieu khien
...
//	else if	(JTA < 15000)	robotRun(JTA, tocdo);
	...
	if (!UP && !DOWN && !RIGHT  && !LEFT && rJoy_LR && robotIsRun()&& !R2)
	robotStop(0);
...
void dua_bong(void)
{
	int i;
	  taget_BT_Xoay = 460;
		//vTaskDelay(3000);
	  while(BienTroNongBanValue > 470 )		{if(wantExit())	break; vTaskDelay(1);}
		XI_LANH_KEPBONG_MO;
		vTaskDelay(5000);
...
//**************************He so cua lazer************************************
		...
		if (force == 73)      result = 14.65, taget_BT_Xoay = degree_F + 7;
		else if (force == 74) result = 14.55, taget_BT_Xoay = degree_F + 7;
		else if (force == 75) result = 14.45, taget_BT_Xoay = degree_F + 7;
		else if (force == 76) result = 14.35, taget_BT_Xoay = degree_F;
		else if (force == 77) result = 14.45, taget_BT_Xoay = degree_F;
		else if (force == 78) result = 14.55, taget_BT_Xoay = degree_F;
		else if (force == 79) result = 14.65, taget_BT_Xoay = degree_F;
		else if (force == 80) result = 14.75, taget_BT_Xoay = degree_F;
		else if (force == 81) result = 14.85, taget_BT_Xoay = degree_F + 6;
		else if (force == 82) result = 14.95, taget_BT_Xoay = degree_F + 5;
		else if (force == 83) result = 15.05, taget_BT_Xoay = degree_F + 5;
		else if (force == 84) result = 15.15, taget_BT_Xoay = degree_F + 5;
		else if (force == 85) result = 15.25, taget_BT_Xoay = degree_F - 5;
		else if (force == 86) result = 15.35, taget_BT_Xoay = degree_F - 5;
		else if (force == 87) result = 15.45, taget_BT_Xoay = degree_F - 5;
		else if (force == 88) result = 15.55, taget_BT_Xoay = degree_F - 5;
		else if (force == 89) result = 15.65, taget_BT_Xoay = degree_F - 4;
		else if (force == 90) result = 15.75, taget_BT_Xoay = degree_F - 4;
		else if (force == 91) result = 15.85, taget_BT_Xoay = degree_F - 4;
		else if (force == 92) result = 15.95, taget_BT_Xoay = degree_F - 4;
		else if (force == 93) result = 16.05, taget_BT_Xoay = degree_F - 4;
		else if (force == 94) result = 16.15, taget_BT_Xoay = degree_F - 3;
		else if (force == 95) result = 16.25, taget_BT_Xoay = degree_F - 3;
		else if (force == 96) result = 16.35, taget_BT_Xoay = degree_F - 3;
		else if (force == 97) result = 16.65, taget_BT_Xoay = degree_F - 10;
		else if (force == 98) result = 16.75, taget_BT_Xoay = degree_F - 10;
		else if (force == 99) result = 16.85, taget_BT_Xoay = degree_F - 10;
		else if (force == 100) result = 16.75, taget_BT_Xoay = degree_F - 2;
		else if (force == 101) result = 17.05, taget_BT_Xoay = degree_F - 2;
		else if (force == 102) result = 16.95, taget_BT_Xoay = degree_F - 2;
		else if (force == 103) result = 17.05, taget_BT_Xoay = degree_F - 1;
		else if (force == 104) result = 17.15, taget_BT_Xoay = degree_F - 1;
		else if (force == 105) result = 17.25, taget_BT_Xoay = degree_F - 1;
		else if (force == 106) result = 17.35, taget_BT_Xoay = degree_F - 1;
		else if (force == 107) result = 17.45, taget_BT_Xoay = degree_F - 1;
		else if (force == 108) result = 17.55, taget_BT_Xoay = degree_F - 1;
		else if (force == 109) result = 17.65, taget_BT_Xoay = degree_F;
		else if (force == 110) result = 17.75, taget_BT_Xoay = degree_F;
		else if (force == 111) result = 18.05, taget_BT_Xoay = degree_F;
		else if (force == 112) result = 18.15, taget_BT_Xoay = degree_F;
		else if (force == 113) result = 18.05, taget_BT_Xoay = degree_F;
		else if (force == 114) result = 18.15, taget_BT_Xoay = degree_F;
		else if (force == 115) result = 18.25, taget_BT_Xoay = degree_F + 1;
		else if (force == 116) result = 18.35, taget_BT_Xoay = degree_F + 1;
		else if (force == 117) result = 18.45, taget_BT_Xoay = degree_F + 1;
		else if (force == 118) result = 18.55, taget_BT_Xoay = degree_F + 1;
		else if (force == 119) result = 18.65, taget_BT_Xoay = degree_F + 2;
		else if (force == 120) result = 18.75, taget_BT_Xoay = degree_F + 2;
...
//**************************He so cua lidar************************************
    ...
    result_lidar = 9.9 - (calculated_force - 150) * 0.25,taget_BT_Xoay = calculated_distance-5;
 }	else if (calculated_force >= 154 && calculated_force <= 156) 
		result_lidar = 9.9 - (calculated_force - 150) * 0.115,taget_BT_Xoay = calculated_distance-5; 
		else if (calculated_force >= 157 && calculated_force <= 160) 
		result_lidar = 10.2 - (calculated_force - 150) * 0.0778,taget_BT_Xoay = calculated_distance-5;
		else if (calculated_force >= 161 && calculated_force <= 165) 
		result_lidar = 10.2 - (calculated_force - 150) * 0.075,taget_BT_Xoay = calculated_distance-5;
		...
		else if (calculated_force >= 180 && calculated_force <= 182) 
		result_lidar = 9.3;
		else if (calculated_force >= 183 && calculated_force <= 185) 
		result_lidar = 9.26;
		else if (calculated_force >= 186 && calculated_force <= 188) 
		result_lidar = 9.22;
    ...
    switch (calculated_force) {
				case 123: result_lidar = 10.01; break;
        case 124: result_lidar = 10.02; break;
        case 125: result_lidar = 10.025; break;
        case 126: result_lidar = 10.03; break;
        case 127: result_lidar = 10.03; break;
        case 128: result_lidar = 10.13; break;
        case 129: result_lidar = 10.28; break;
        case 130: result_lidar = 10.31; break;
        case 131: result_lidar = 10; break;
        case 132: result_lidar = 10; break;
        case 133: result_lidar = 10.13; break;
        case 134: result_lidar = 10.13; break;
        case 135: result_lidar = 10.13, taget_BT_Xoay = calculated_distance-5 ; break;
        case 136: result_lidar = 10.23, 	taget_BT_Xoay = calculated_distance-5; break;
        case 137: result_lidar = 10.34; break;
        case 138: result_lidar = 10.45; break;
        case 139: result_lidar = 10.45; break;
			case 140: result_lidar = 10,taget_BT_Xoay = calculated_distance-7;;break;
        case 141: result_lidar = 10,taget_BT_Xoay = calculated_distance-7;; break;
        case 142: result_lidar = 10,taget_BT_Xoay = calculated_distance-7;; break;
        case 143: result_lidar = 10,taget_BT_Xoay = calculated_distance-7;; break;
        case 144: result_lidar = 10,taget_BT_Xoay = calculated_distance-7;; break;
        case 145: result_lidar = 9.95,taget_BT_Xoay = calculated_distance-7;; break;
        case 146: result_lidar = 9.4,taget_BT_Xoay = calculated_distance-7;; break;
        case 147: result_lidar = 9.37,taget_BT_Xoay = calculated_distance-7;; break;
        case 148: result_lidar = 9.34,taget_BT_Xoay = calculated_distance-7;; break;
        case 149: result_lidar = 9.3,taget_BT_Xoay = calculated_distance-7; break;
				case 166: result_lidar = 9.05,taget_BT_Xoay = calculated_distance-5; break;
				case 167: result_lidar = 9.05,taget_BT_Xoay = calculated_distance-5; break;
				case 168: result_lidar = 9.21,taget_BT_Xoay = calculated_distance-5; break;
				case 169: result_lidar = 9.205,taget_BT_Xoay = calculated_distance-5; break;
				
				//dang chinh luc gan het pin//
				case 170: result_lidar = 9.4,taget_BT_Xoay = calculated_distance-5; break;
				case 171: result_lidar = 9.365,taget_BT_Xoay = calculated_distance-5; break;
				case 172: result_lidar = 9.345,taget_BT_Xoay = calculated_distance-5; break;
				case 173: result_lidar = 9.33,taget_BT_Xoay = calculated_distance-5; break;
				case 174: result_lidar = 9.31,taget_BT_Xoay = calculated_distance-5; break;
				// ///////////////
				
				case 175: result_lidar = 9.25, taget_BT_Xoay = calculated_distance - 5; break;
				case 176: result_lidar = 9.2105, taget_BT_Xoay = calculated_distance - 6; break;
				case 179: result_lidar = 9.23, taget_BT_Xoay = calculated_distance - 5; break;				
				case 202: result_lidar = 9.08, taget_BT_Xoay = calculated_distance - 5; break;
				case 203: result_lidar = 9.06, taget_BT_Xoay = calculated_distance - 5; break;
				case 204: result_lidar = 9.04, taget_BT_Xoay = calculated_distance - 5; break;
				case 205: result_lidar = 9.02, taget_BT_Xoay = calculated_distance - 5; break;
				case 206: result_lidar = 8.9, taget_BT_Xoay = calculated_distance - 5; break;
				case 207: result_lidar = 8.7, taget_BT_Xoay = calculated_distance - 5; break;
				case 208: result_lidar = 8.4, taget_BT_Xoay = calculated_distance - 5; break;
...
//		final_result_lidar =calculated_force ;
        ...
        taget_BT_Xoay = calculated_distance;
    }
}
