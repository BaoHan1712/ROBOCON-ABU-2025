...
#define mor_8h_next 											 		DATA_SPEED[6]=0
#define mor_8h_back 													DATA_SPEED[6]=1
#define	mor_8h																DATA_SPEED[7]

#define	DIA_CHI_START3 												DATA_SPEED[8]=255
#define	ID3 		 															DATA_SPEED[9]=3
#define mor_4h_next 													DATA_SPEED[10]=0
#define mor_4h_back 													DATA_SPEED[10]=1
...
#define  XI_LANH_KEPLUATREN_ON							GPIO_WriteBit(GPIOB,GPIO_Pin_7,1) // -- OK
#define  XI_LANH_KEPLUATREN_OFF							GPIO_WriteBit(GPIOB,GPIO_Pin_7,0)

#define  XI_LANH_KEPLUADUOI_ON							GPIO_WriteBit(GPIOB,GPIO_Pin_11,1) // -- OK
#define  XI_LANH_KEPLUADUOI_OFF							GPIO_WriteBit(GPIOB,GPIO_Pin_11,0)

#define  XI_LANH_NANG_LUA_LEN_ON						GPIO_WriteBit(GPIOB,GPIO_Pin_12,1) // -- OK
#define  XI_LANH_NANG_LUA_LEN_OFF						GPIO_WriteBit(GPIOB,GPIO_Pin_12,0)

#define  XI_LANH_NANG_LUA_XUONG_ON						GPIO_WriteBit(GPIOD,GPIO_Pin_10,1) // -- OK
#define  XI_LANH_NANG_LUA_XUONG_OFF						GPIO_WriteBit(GPIOD,GPIO_Pin_10,0)
...
#define  CB_XL_NANG_LUA_1												GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_5)
