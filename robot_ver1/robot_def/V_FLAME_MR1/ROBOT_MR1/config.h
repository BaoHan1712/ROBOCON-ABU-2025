...
#define Mor_RearRight_thuan	 					 			  DATA_SPEED[2]=0
#define Mor_RearRight_nghich 									DATA_SPEED[2]=1
#define	Mor_RearRight				 		 							DATA_SPEED[3]

#define	DIA_CHI_START2 												DATA_SPEED[4]=255
#define	ID2 		 															DATA_SPEED[5]=2
#define Mor_RearLeft_thuan			 							DATA_SPEED[6]=1
#define Mor_RearLeft_nghich							    	DATA_SPEED[6]=0
#define	Mor_RearLeft 						 							DATA_SPEED[7]

#define	DIA_CHI_START3 												DATA_SPEED[8]=255
#define	ID3 		 															DATA_SPEED[9]=3
#define Mor_FrontRight_thuan 									DATA_SPEED[10]=0
#define Mor_FrontRight_nghich				 					DATA_SPEED[10]=1
#define	Mor_FrontRight				 		 						DATA_SPEED[11]

#define	DIA_CHI_START4 												DATA_SPEED[12]=255
#define	ID4 		 															DATA_SPEED[13]=4
#define Mor_FrontLeft_thuan					 					DATA_SPEED[14]=1
#define Mor_FrontLeft_nghich					        DATA_SPEED[14]=0
#define	Mor_FrontLeft 		 										DATA_SPEED[15]
...
#define  CB_HOME_BAN_XOAY												GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_0)
...
#define  CB_NHAN_BONG	 													GPIO_ReadInputDataBit(GPIOE,GPIO_Pin_15) // -- OK
//NUT BAM
...
//										}
									...
									case 14:
										...
										break;		
									case 15:
										HMI_DMI("track:",tocdoXoaytrack,15); 
										break;	
								  case 16:
